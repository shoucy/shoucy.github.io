...
先说说正向代理，我们用过或听过的科学上网就是正向代理服务器。我们访问某个网站，可这个网站基于某些原因不为我们提供服务，这时就可以使用科学上网，我们将请求发送给科学上网提供商，科学上网提供商就是我们的代理，帮我们来传达请求，以得到正常的服务。**在正向代理过程中，网站只能接触到科学上网提供商，并不知道我们的真实身份。**
